...
<body class="hold-transition login-page" style="background: linear-gradient(87deg, #11cdef 0, #1171ef 100%) !important;">
	<div class="login-box">
		<div class="login-logo">
			<b class="text-light">Pemuda Karang Taruna Dusun Ngreno</b>
		</div>
		<div class="card">
			<div class="card-header">
				<img class="card-img-top img-rounded" src="assets/img/ngreno.jpg" alt="">
			</div>
	...
	if(isset($_POST['submit'])) {
		...
		if($cek > 0) {
			...
			if(password_verify($password, $data['password'])) {
				$_SESSION['mlebet'] = true;
				$_SESSION['idrem'] = $id_pengguna;
				setcookie('version', $id_pengguna, time() + (60 * 60 * 24 * 5), '/');
				setcookie('key', hash('sha256', $username1), time() + (60 * 60 * 24 * 5), '/');
				echo "<script>
